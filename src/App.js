...
import QuestionsDetailPage from './components/QuestionDetailPage/QuestionsDetailPage'; // Import QuestionDetailPage
  ...
  return (
    <AuthProvider>
      ...
      <Routes>
        ...
        <Route path="/questions/:questionId" element={<QuestionsDetailPage />} /> {/* Add this line */}
      </Routes>
    </AuthProvider>
  );
}
